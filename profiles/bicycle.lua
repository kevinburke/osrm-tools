-- Custom Bicycle profile with street preferences
-- This is based on the original OSRM bicycle profile with minimal modifications
...
-- Load our custom street preferences
local street_preferences = require('street_preferences')
...
function process_node(profile, node, result)
  ...
  if street_preferences and street_preferences.apply_node then
    street_preferences.apply_node(profile, node, result)
  end
end
...
function process_way(profile, way, result)
  ...
  -- CUSTOM: Apply street preferences after all standard processing
  street_preferences.apply(way, result)
end
...
function process_segment(profile, segment)
  street_preferences.apply_segment(profile, segment)
end
